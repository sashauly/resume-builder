...
vi.mock("@/components/form/personal-info-form", () => ({
  PersonalInfoForm: ({ initialData, onSave }: any) => (
...
vi.mock("@/components/form/education-form", () => ({
  EducationForm: ({ initialData, onSave }: any) => (
...
vi.mock("@/components/form/experience-form", () => ({
  ExperienceForm: ({ initialData, onSave }: any) => (
...
vi.mock("@/components/form/skills-form", () => ({
  SkillsForm: ({ initialData, onSave }: any) => (
    <div data-testid="skills-form">
      <button
        data-testid="save-skills"
        onClick={() => onSave(["JavaScript", "React"])}
      >
        Save Skills
      </button>
    </div>
...
vi.mock("@/components/resume-preview", () => ({
  ResumePreview: ({ data, template }: any) => (
