...
export const translations: { en: Translations; ru: Translations } = {
  en: {
    ...
    skills: {
      ...
      skillPlaceholder: 'Enter skills (comma-separated)',
      addButton: 'Add',
      yourSkills: 'Your Skills',
      noSkills: 'No skills added yet',
      removeSkill: 'Remove',
      inputHelp: 'Add your professional skills and competencies',
      inputInstructions:
        'Type skills and press Enter or click Add. You can add multiple skills at once by separating them with commas.',
      inputAriaLabel: 'Skills input field',
      addButtonAriaLabel: 'Add skills',
      skillsListAriaLabel: 'List of your skills',
  ...
  ru: {
    ...
    skills: {
      ...
      skillPlaceholder: 'Введите навыки (через запятую)',
      addButton: 'Добавить',
      yourSkills: 'Ваши Навыки',
      noSkills: 'Навыки еще не добавлены',
      removeSkill: 'Удалить',
      inputHelp: 'Добавьте ваши профессиональные навыки и компетенции',
      inputInstructions:
        'Введите навыки и нажмите Enter или кнопку Добавить. Вы можете добавить несколько навыков сразу, разделяя их запятыми.',
      inputAriaLabel: 'Поле ввода навыков',
      addButtonAriaLabel: 'Добавить навыки',
      skillsListAriaLabel: 'Список ваших навыков',
      removeSkillAriaLabel: 'Удалить навык',
    },
    templates: {
